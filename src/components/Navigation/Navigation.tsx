...
export const Navigation = () => {
  ...
  return (
    ...
    isScrolled
    ? 'bg-accent-yellow/95 border-b border-gta-panel-light shadow-gta'
    : 'bg-accent-yellow'
    }`}
      >
  ...
  <div className="flex items-center gap-3">
    {/* เส้นเหลืองเดิม (ถ้าจะเก็บไว้) */}
    <div className="w-1 h-8 bg-accent-yellow" />

    {/* โลโก้หน้าแบรนด์ */}
    <div className="flex items-center gap-3"></div>
    <div className="relative flex items-center justify-center w-10 h-10 rounded-full bg-white/95 shadow-lg shadow-black/20">
    <img
      src="/assets/tlc-logo.svg"
      alt="The Living City"
    ...
    {/* ข้อความชื่อเซิร์ฟเวอร์ */}
    <span className="font-display text-2xl text-gta-black uppercase">
                  ...
                  return (
                    <button
                      ...
                      className={`
                        ...
                        ${isActive ? 'text-accent-blue' : 'text-gta-black hover:text-gta-black'}
                      `}
                    >
                      {item}
                      {isActive && (
        ...
        <>
          ...
          >
            <div className="p-8">
              <button
                onClick={() => setIsMenuOpen(false)}
                className="absolute top-6 right-6 p-2 text-gta-black hover:text-gta-black"
              >
                <X className="w-6 h-6" />
              </button>
                    ...
                    return (
                      <button
                        ...
                        className={`
                          ...
                          ${isActive ? 'text-accent-blue bg-gta-panel-light border-l-4 border-accent-blue' : 'text-gta-black hover:text-gta-black'}
                        `}
                        style={{ opacity: 0 }}
                      >
